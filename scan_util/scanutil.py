...
def if_over_totalsupply(chain, contract_address, address):
    if chain == "bsc":
        mainnet_w3 = Web3(HTTPProvider(
                    'https://restless-little-paper.bsc.discover.quiknode.pro/77fac075694faf5935b6f199c38df1a0a5be6c37/'))
    else:
    ...
    contract = mainnet_w3.eth.contract(Web3.toChecksumAddress(contract_address),
                               abi=str(erc20_abi))
    number = contract.functions.balanceOf(Web3.toChecksumAddress(address)).call()
...
if __name__ == "__main__":
    ...
    # print(result)
    if_over_totalsupply("bsc", "0xc2319e87280c64e2557a51cb324713dd8d1410a3", "0xc2319e87280c64e2557a51cb324713dd8d1410a3")
